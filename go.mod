...
replace (
	github.com/shirou/gopsutil/v4 => github.com/shirou/gopsutil/v4 v4.25.11
	github.com/tklauser/go-sysconf => github.com/tklauser/go-sysconf v0.3.16
	github.com/tklauser/numcpus => github.com/tklauser/numcpus v0.11.0
