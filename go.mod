...
replace (
	github.com/shirou/gopsutil/v4 => github.com/shirou/gopsutil/v4 v4.25.9
	github.com/tklauser/go-sysconf => github.com/tklauser/go-sysconf v0.3.15
	github.com/tklauser/numcpus => github.com/tklauser/numcpus v0.10.0
